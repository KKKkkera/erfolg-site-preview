...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      {...props}
    >
      {/* Кнопок-стрелок нет: список прокручивается колесом, как обычный
          скролл-контейнер. Потолок высоты — здесь же, чтобы попап не уезжал
          за экран. */}
      <SelectPrimitive.Viewport
        className={cn(
          "max-h-[min(20rem,60vh)] overflow-y-auto overscroll-contain p-1",
