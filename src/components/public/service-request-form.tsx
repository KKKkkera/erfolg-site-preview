...
} from "@/server/actions/service-request";
import {
  AttachmentField,
  ConsentField,
...
export function ServiceRequestForm() {
  ...
  return <ServiceRequestFormInner />;
}

function ServiceRequestFormInner() {
  const [state, formAction] = useFormState(submitServiceRequest, initialState);
      ...
      <fieldset className="space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Field
            ...
            required
            placeholder="Аппарат ИВЛ / УЗИ / монитор пациента"
            error={state.errors?.equipmentName}
          />
          <Field
            name="manufacturer"
            label="Производитель"
            optional
            placeholder="Например, GE / Philips / Mindray"
        ...
        <div className="space-y-1.5">
          ...
          <Textarea
            ...
            rows={5}
            required
            placeholder="Опишите проблему, частоту возникновения, наблюдаемые ошибки на дисплее"
          />
