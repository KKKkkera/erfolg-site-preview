export const siteConfig = {
  ...
  description:
    "ООО «Эрфольг» — собственный сервисный центр медицинской техники по лицензии Росздравнадзора (ТОМИ) и поставка оборудования по всей России. Работаем по 44 и 223-ФЗ.",
  url: process.env.NEXT_PUBLIC_SITE_URL ?? "https://erfolgmt.ru",
  contacts: {
    phonePrimary: "+7 (920) 444 - 22 - 22",
    email: "info@erfolgmt.ru",
    addressShort: "Поставка по всей России",
  },
