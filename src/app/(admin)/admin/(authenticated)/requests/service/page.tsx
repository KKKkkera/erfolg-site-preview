...
export const metadata = { title: "Заявки на сервис — Эрфольг" };
...
export default async function ServiceRequestsPage(
  ...
  let dbError = false;
  try {
    rows = await db.serviceRequest.findMany({
      where: status
  ...
  return (
    <div className="space-y-6">
      ...
      <RequestsTabs current="service" />
      <RequestStatusFilter base="/admin/requests/service" status={status} />
      {dbError ? (
